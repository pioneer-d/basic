...
<body>
	<form name = "f"  method="post" onsubmit="return Compare()" action = "memberInfoUpdateConfirm">
        ...
        <tr>
            ...
            <td><input type="password" Name="pwd" id="pwd" SIZE="20" maxlength="12" value = "${User.m_Pwd}">&nbsp4~12자의 영문 대소문자와 숫자로만 입력</td>
        </tr>
        <tr>
            <td bgcolor=#e6e6e6 align="center"><b>비밀번호 확인:</b></td>
            <td><input type="password" Name="pwd" id="pwd2" SIZE="20" maxlength="12" value = "${User.m_Pwd}"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" Name="num" id="num" SIZE="10" maxlength="6" value = "${User.m_Num1}" readonly>&nbsp-
                <input type="password" Name="num2" id="num2" SIZE="10" maxlength="7" value = "${User.m_Num2}" readonly>
