	...
	<table width="50%" height="80" border="1" align="center"
		...
		<tr align="center">
			<td colspan="2" align="center" bgcolor="#339999">
				<div style="font-weight: bold; font-size: 18px">Gallery조회</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td bgcolor="##FFCC00" align="center"><div
					style="font-weight: bold;">게시글제목:</div></td>
			<td>&nbsp <%= arr[1] %>
			</td>
		</tr>
		<tr>
			<td bgcolor="##FFCC00" align="center"><div
					style="font-weight: bold;">그림:</div></td>
			<td>&nbsp <%= arr[2] %></td>
		</tr>
		<tr>
			<td bgcolor="##FFCC00" align="center"><div
					style="font-weight: bold;">예약번호:</div></td>
			<td>&nbsp <%= arr[3] %></td>
		</tr>
	</table>
	<div align=center>
