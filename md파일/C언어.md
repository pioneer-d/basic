...
포인터 1번째까지 복습함. 2번쨰부터 시작하고

회사 차량관리 분석 부분 부터 다시 분석
...
문제 8 => homework_8.c 완료 (버블정렬 사용.)
위 입력받는 학생들의 성적을 높은 순으로 정렬하는 프로그램을 만들어 보세요.

문제 9
입력받은 학생들의 성적을 막대 그래프로 나타내는 프로그램을 만들어 보세요. => 보류

문제 10 => homework_10.c 진행중
