...
import com.snaptag.labcode_china.navigation.more.data.ChildData;
...
public class FrequentQuestionAdapter_Test extends BaseExpandableListAdapter {
    ...
    public FrequentQuestionAdapter_Test(Activity activity, List<String> mGroup, Map<String, List<Integer>> mChild){
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        ((TextView)convertView.findViewById( R.id.child_text )).setText( mChild.get( mGroup.get( groupPosition ) ).get( childPosition ) );
